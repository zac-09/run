...
function setChart(list_values, list_period, chartName){
    // Area Chart Example
...
// labels = ["zac","marry","zion"];
// values = [];
       

//         function soilData(callback){
//           var xhr = new XMLHttpRequest();
//             xhr.open('GET','../lineGraph.php',true);
...
$("chart-area").mouseover(function(){
  $.ajax({
    url : "http://http://134.209.193.225/classes/lineGraph.php",
    type : "GET",
